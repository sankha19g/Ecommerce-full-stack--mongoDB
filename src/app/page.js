...
export default function home() {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-50 lg:mt-100">
            ...
            <Link href="/products">
                <button className=" lg:mt-5 flex items-center justify-center gap-2 bg-[#866528] px-5 py-3 rounded-md text-white border-2 m-2 cursor-pointer group transition-all">
